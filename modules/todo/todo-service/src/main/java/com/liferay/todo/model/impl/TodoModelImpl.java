...
public class TodoModelImpl extends BaseModelImpl<Todo> implements TodoModel {
	...
	public static final String TABLE_SQL_CREATE = "create table TODO_Todo (uuid_ VARCHAR(75) null,todoId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,title VARCHAR(75) null,description VARCHAR(75) null,completed BOOLEAN)";
	public static final String TABLE_SQL_DROP = "drop table TODO_Todo";
	public static final String ORDER_BY_JPQL = " ORDER BY todo.createDate DESC";
	public static final String ORDER_BY_SQL = " ORDER BY TODO_Todo.createDate DESC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.todo.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.todo.model.Todo"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.todo.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.todo.model.Todo"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.todo.service.util.ServiceProps.get(
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.todo.service.util.ServiceProps.get(
	...
	public Object clone() {
		...
		todoImpl.setCompleted(getCompleted());
	...
	public CacheModel<Todo> toCacheModel() {
		...
		todoCacheModel.completed = getCompleted();
